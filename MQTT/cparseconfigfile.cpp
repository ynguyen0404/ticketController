...
cParseConfigFile::cParseConfigFile(QObject *parent) : QObject(parent){}

cParseConfigFile::~cParseConfigFile(){}

cConnectInfo cParseConfigFile::getConfigurationData()
{
    cConnectInfo m_connInfo;
...
void cParseConfigFile::setConfigurationData(cConnectInfo conInfo)
{
